<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ErroresPagina.aspx.cs" Inherits="UTTT.Ejemplo.Persona.ErroresPagina" %>
...
<body>
    <form id="form1" runat="server">
        <div style=" width:100%; text-align:center; ">
            ...
            <br />
                <asp:TextBox ID="txtmsj" runat="server" Visible="False" Height="70px" Width="291px" ></asp:TextBox>
            <br />
            </div>
            <br />
            <div>
            ...
            <br />
                <asp:TextBox ID="txtAsunto" runat="server" Visible="False" Width="206px"></asp:TextBox>
            <br />
            <br />
            </div>
            <div>
                ...
                <br />
                <asp:TextBox ID="txtEmail" runat="server" type="email" placeholder="Correo destinatario" Visible="False" Width="288px"></asp:TextBox>
            <br />
            <br />
