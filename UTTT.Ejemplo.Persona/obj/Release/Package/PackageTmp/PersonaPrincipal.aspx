        ...
        <div>
             ...
             <asp:GridView ID="dgvPersonas" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="dteFecha" HeaderText="FechaN" ReadOnly="True" 
                        SortExpression="strAMaterno" />
                    <asp:BoundField DataField="strCorreoE" HeaderText="Correo E" ReadOnly="True" 
                        SortExpression="strAMaterno" />
                    <asp:BoundField DataField="strCodigoP" HeaderText="Codigo P" ReadOnly="True" 
                        SortExpression="strAMaterno" />
